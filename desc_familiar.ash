...
string JSSSS="<script>document.write(new URL(window.location.href).searchParams.get(\"which\") || '???');</script>";
...
/*
//do I want to see the hatchling?
item c=to_familiar(fam).hatchling;
string baby="hatchling: "+(c==$item[none] ? "???" : "<b><a style=\"text-decoration: none;\" href=desc_item.php?whichitem="+c.descid+">"+c+"</a></b>")+"<br>";
*/
page.replace_string("</body>",out+"</center><p>"+LAD+"</body>");
